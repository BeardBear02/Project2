...
try {
    ...
    if($row['Description'] == null){
        $row['Description'] = "NO discription";
    }
...
function outputKudos($favorRes){
    try {
        ...
        if($row1['LIKES'] == 0){
            echo '<input type="button" id="kudos" name="kudos" value="Like '.$favorRes['kudos'].'">';
        }
        else{
            echo '<input type="button" id="collected" name="kudos" value="cancel like">';
        }
        $pdo = null;
    }
    catch (PDOException $e) {
